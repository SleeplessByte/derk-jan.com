...
date: "2025-10-11T21:03:00Z"
description: ""
---

import Component from "../../../../../components/Codepen/Embed.astro";
import PreviewDigitLayout from "../../../../../components/articles/recreating-clock-of-clocks/PreviewDigitLayout.astro";
import PreviewTinyClockLayout from "../../../../../components/articles/recreating-clock-of-clocks/PreviewTinyClockLayout.astro";
import PreviewTinyClockCssVariable from "../../../../../components/articles/recreating-clock-of-clocks/PreviewTinyClockCssVariable.astro";
import PreviewTinyClockVariations from "../../../../../components/articles/recreating-clock-of-clocks/PreviewTinyClockVariations.astro";
import PreviewTinyClockDigitZero from "../../../../../components/articles/recreating-clock-of-clocks/PreviewTinyClockDigitZero.astro";
import PreviewTinyClockDigits from "../../../../../components/articles/recreating-clock-of-clocks/PreviewTinyClockDigits.astro";
import PreviewTinyClockTransition from "../../../../../components/articles/recreating-clock-of-clocks/PreviewTinyClockTransition.astro";

import { Image } from "astro:assets"
import clocksImage from "../../../../../assets/articles/recreating-clock-of-clocks/clocks.jpg";

Recently [I saw][source-reddit] a very intriguing concept of a Clock made of Clocks which made me think of a [real life object by Humans Since 1982][source-physicial].
...
- The initial clock face is randomised;
...
The requirement however is that each face only moves clockwise, so this doesn't quite work, or at least: it's not enough.
In order to make the transition work only clockwise, I could instead steadily increase the rotation.


[source-reddit]: https://www.reddit.com/r/webdev/comments/1nrx5n9/clock_made_of_clocks/
[source-physicial]: https://www.humanssince1982.com/en-eu
