...
cover: "../../../../articles/expo-facebook-login/cover.jpg"
---
...
![Interface on developers.facebook.com, showing the My Apps menu with the Create App option](../../../../articles/expo-facebook-login/facebook1.PNG)

On the popup, pick _For Everything Else_, unless you're making a mobile game that's **not** an Instant Game or Canvas Game.

![The popup that appears when creating a new app, depicting three options with the question "How are you using your app?". The third option is "For Everything Else".](../../../../articles/expo-facebook-login/facebook2.PNG)

Finally, fill in the **App Display Name** and **App Contact Email**:

![The "For Everything Else" form with the title Create an App ID](../../../../articles/expo-facebook-login/facebook3.PNG)
...
![Final state of the App creation process, including the APP ID.](../../../../articles/expo-facebook-login/facebook4.PNG)
...
![Indicating the settings for Facebook Login on the developers.facebook.com website.](../../../../articles/expo-facebook-login/facebook5.PNG)
...
![Error page on the phone showing "Something went wrong trying to finish signing in. Please close this creen to go back to the app."](../../../../articles/expo-facebook-login/expo-error.jpg)
...
![Screen prompting the user in a browser to sign into another service.](../../../../articles/expo-facebook-login/expo-confirm.jpg)
...
![](../../../../articles/expo-facebook-login/facebook7.PNG)
