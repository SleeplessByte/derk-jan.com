...
const DATA = {
  status: [
    ...
    ["Meetup", "green", "green"],
    ["Phone", "red", "red"],
    ["Karaoke", "orange", "green"],
    ["Code of Conduct", "green", "green"],
    ["Sponsoring", "green", "green"],
  ],
};
...
export default function Page({
  ...
  return (
    <div
      className={`min-h-full relative ${fixOutlines ? "fix-outline-none" : ""}`}
    >
      <a
        href="#content"
        className="z-20 transition sr-only focus:not-sr-only rounded-md focus:fixed focus:top-4 focus:left-4 focus:dark:bg-zinc-900 focus:bg-zinc-100 focus:shadow-xl focus:outline-none focus:ring-2 focus:ring-pink-500 dark:focus:ring-yellow-500"
      >
        <span className="block p-2">Skip to main content</span>
      </a>
      <header className="bg-[lightskyblue] pb-32">
        <div className="max-w-3xl mx-auto flex justify-between items-center py-4 px-4 sm:px-6 lg:px-8 relative">
          <a href="https://techa11y.dev">
            <img
              src={logoSrc.src}
              width={563}
              height={120}
          ...
          <button
            className="outline-none hover:opacity-50 text-zinc-800"
            type="button"
            onClick={() => open("mailto:amsterdam.rb@example.org")}
          >
            <svg
        ...
        <div className="max-w-3xl mx-auto items-center py-4 px-4 sm:px-6 lg:px-8 hidden md:block">
          <div className="flex items-center justify-between h-16 border-zinc-900  border rounded-sm">
            <nav className="flex items-center">
              <div className="flex-shrink-0"></div>
              <div className="flex items-baseline space-x-4 ml-4">
                <a
                  href="https://techa11y.dev/"
                  className="text-zinc-700 hover:bg-zinc-900/50 hover:text-zinc-100 px-3 py-2 rounded-md text-sm font-medium unstyled-link outline-none"
                >
                  Home
                </a>
                ...
                <a
                  href="#content"
                  className="bg-zinc-900 text-white px-3 py-2 rounded-md text-sm font-medium unstyled-link outline-none"
                  aria-current="page"
                >
                  Status
                </a>
                ...
                <a
                  href="https://techa11y.dev/code-of-conduct/"
                  className="text-zinc-700 hover:bg-zinc-900/50 hover:text-zinc-100 px-3 py-2 rounded-md text-sm font-medium unstyled-link outline-none"
                >
                  Code of Conduct
                </a>
                ...
                <a
                  href="https://techa11y.dev/sponsors"
                  className="text-zinc-700 hover:bg-zinc-900/50 hover:text-zinc-100 px-3 py-2 rounded-md text-sm font-medium unstyled-link outline-none"
                >
                  Sponsorships
                </a>
                ...
                <a
                  href="https://techa11y.dev/sessions-2021/"
                  className="text-zinc-700 hover:bg-zinc-900/50 hover:text-zinc-100 px-3 py-2 rounded-md text-sm font-medium unstyled-link outline-none"
                >
                  Give a talk
                </a>
        ...
        <h1 className="sr-only md:hidden">
          Welcome to the A11y.lowlands status page
        </h1>

        <div className="max-w-3xl mx-auto items-center py-4 px-4 sm:px-6 lg:px-8 relative min-h-[200px] hidden md:block">
          <h1 className="text-2xl font-bold max-w-sm text-zinc-800">
            Welcome to the A11y.lowlands status page
          </h1>
          <p className="mt-2 text-lg font-normal leading-6 max-w-sm text-zinc-700">
            Below you'll find status information for each of the various
            activities and services this community provides.
          </p>

          <div className="absolute -bottom-12 right-8 max-w-[200px] w-full">
            <svg
              viewBox="0 0 400 400"
              xmlns="http://www.w3.org/2000/svg"
              aria-hidden="true"
      ...
      <div className="-mt-32">
        <div className="max-w-3xl mx-auto pb-12 px-4 sm:px-6 lg:px-8">
          <main
            className="bg-white rounded-lg shadow px-5 py-6 sm:px-6 relative light"
            id="content"
          >
            <section
              className="rounded-md bg-blue-100 border border-blue-600 p-4"
              aria-labelledby="title-note"
            >
              <h2 className="sr-only" id="title-note">
                Note for Dutch speaking visitors:
              </h2>

              <div className="flex" lang="nl">
                ...
                <div className="ml-3 flex-1 md:flex md:justify-between">
                  <div className="text-sm text-blue-700">
                    We zijn een internationale community en al onze services
                    zijn in het engels. Deze status pagina is daarom ook alleen
                    in het Engels beschikbaar. Kom je er niet uit? Neem dan
                    contact met ons op.
                  </div>
                  <div className="mt-3 text-sm md:mt-0 md:ml-6">
                    <a
                      className="whitespace-nowrap font-medium text-blue-700 hover:text-blue-600 outline-none unstyled-link"
                      href="mailto:amsterdam.rb@example.org"
                    >
            ...
            <section aria-label="The actual status of the services">
              <div
                className="mt-6 text-zinc-600 font-semibold"
                aria-hidden="true"
              >
                Legend
              </div>
              <ul
                className="flex space-x-4 items-center mt-1"
                aria-hidden="true"
              >
                ...
                <li className="flex items-center space-x-1">
                  <span className="rounded-full w-4 h-4 bg-[#c49b21] block" />
                  <span className="text-zinc-400">Issue</span>
                </li>
                <li className="flex items-center space-x-1">
                  <span className="rounded-full w-4 h-4 bg-[#e66b6b] block" />
                  <span className="text-zinc-400">Outage</span>
                </li>
              </ul>
              ...
              <div className="shadow-sm rounded-sm ring-1 ring-black ring-opacity-5 max-w-sm mt-1  overflow-auto">
                <table className="min-w-full">
                  <caption className="sr-only">
                    Current status per service. There are {numberOfIssues(data)}{" "}
                    issues and {numberOfOutages(data)} outages in total
                  </caption>
                  <thead className="bg-zinc-100">
                    <tr>
                      ...
                      <th
                        scope="col"
                        className="relative py-3.5 px-3 text-gray-900 italic"
                      >
                        Amsterdam
                      </th>
                      <th
                        scope="col"
                        className="relative py-3.5 pl-3 pr-4 sm:pr-6 text-gray-900 italic"
                      >
                        Utrecht
                      </th>
                    </tr>
                  ...
                  <tbody className="divide-y divide-zinc-200 bg-white">
                    {data.map(([key, first, second]) => (
                      <tr key={key}>
                        <th
                          scope="row"
                          className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6 text-right"
                        >
                          {key}
                        </th>
                        ...
                        {second !== undefined ? (
                          <td className="relative whitespace-nowrap py-4 px-3 text-center text-sm font-medium">
                            <div className="flex items-center space-x-1">
                              <StatusIndicator value={first} />
                              <StatusValue label="Amsterdam" value={first} />
                            </div>
                          </td>
                        ) : null}
                        ...
                        <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-center text-sm font-medium sm:pr-6">
                          <div className="flex items-center space-x-1">
                            <StatusIndicator value={second || first} />
                            <StatusValue
                              label="Utrecht"
                              value={second || first}
                            />
...
function numberOfIssues(data: string[][]) {
  return data.reduce((result, [, first, second]) => {
    return (
      result + (first === "orange" ? 1 : 0) + (second === "orange" ? 1 : 0)
    );
  }, 0);
}

function numberOfOutages(data: string[][]) {
  return data.reduce((result, [, first, second]) => {
    return result + (first === "red" ? 1 : 0) + (second === "red" ? 1 : 0);
  }, 0);
}
...
function StatusIndicator({ value }: { value: string }) {
  switch (value) {
    case "green": {
      return <span className="rounded-full w-4 h-4 bg-green-500 block" />;
    }

    case "orange": {
      return <span className="rounded-full w-4 h-4 bg-[#c49b21] block" />;
    }

    case "red": {
      return <span className="rounded-full w-4 h-4 bg-[#e66b6b] block" />;
    }
...
function StatusValue({ value, label }: { value: string; label: string }) {
  switch (value) {
    ...
    case "orange": {
      return <span className="sr-only">issue</span>;
    }

    case "red": {
      return <span className="sr-only">outage</span>;
    }
